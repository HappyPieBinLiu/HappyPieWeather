...
public class HappyPieWeatherDB {

    /**
     * The name of the DataBase
     */
    public static final String DB_NAME = "HappyPie_weather";
     ...
     * create a instance
     */
    public synchronized static HappyPieWeatherDB getInstance (Context context){

        if (happyPieWeatherDB == null){
            happyPieWeatherDB = new HappyPieWeatherDB(context);
        }
        return happyPieWeatherDB;
    }
    /**
     * Sava Province data。
     */
